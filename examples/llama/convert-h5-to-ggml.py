# Convert LLaMa .pth transformer model to ggml format
#
...
fname_out = sys.argv[1] + "/llama-fp16.bin"
...
fout.write(struct.pack("i", hparams["n_hddn"]))
fout.write(struct.pack("i", hparams["n_head"]))
fout.write(struct.pack("i", hparams["n_layer"]))# 1))
